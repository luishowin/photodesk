...
| Phase | State |
|---|---|
| Spec | v0.11 — [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) |
...
1. **Name the export gamut-mapping policy.** §4 says "linear P3 → tone encode → sRGB" and stops. The harness clips per channel in linear light, decided in a test file rather than in the spec — and this is no longer abstract: real P3 photographs move by **up to ΔE 2.86** on export to sRGB under that policy.
